...
Alle logica met (onder andere) betrekking tot de API endpoints zitten in _services_ weggestopt, waar het `webshop-root`-component (en later andere componenten) gebruik van maakt.
